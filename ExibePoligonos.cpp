...
int nfaixas = 10; //cria 10 faixas por definiÁao, pode ser mudado
Poligono Mapa;
Poligono ConvexHull;
...
void init()
{
    // Define a cor do fundo da tela PRETO para melhor visualizaÁao das cores dos vertices e arestas
...
void initOLD(void)
{
    ...
    // Seta os limites da área de desenho
    Min = Ponto(-10, -10, 0);
    Max = Ponto( 10,  10, 1);
}
